...
import { Box, Text, Heading, VStack, Spinner, Center, Image, Stack, AspectRatio, HStack, Button } from 'native-base';
  ...
  const renderStationItem = ({ item }: { item: Station }) => (
    <Box alignItems="center" mb={4}>
      <Box 
        ...
        borderWidth="1" 
        _dark={{ borderColor: "coolGray.600", backgroundColor: "#B3E5FC" }} // Fundo azul claro para modo escuro
        _light={{ backgroundColor: "#E0F7FA" }} // Fundo azul claro para modo claro
      >
        <Box>
        ...
        <Stack p="4" space={3}>
          ...
          <Text fontWeight="400">
            Tipo de energia: {item.energy_type.toUpperCase()}
          </Text>
        </Stack>
      </Box>
    </Box>
